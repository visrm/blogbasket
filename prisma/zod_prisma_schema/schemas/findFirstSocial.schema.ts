...
export const SocialFindFirstSelectSchema: z.ZodType<Prisma.SocialSelect> = z.object({
...
export const SocialFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    profileId: z.boolean().optional(),
    profile: z.boolean().optional(),
    youtubeUrl: z.boolean().optional(),
...
export const SocialFindFirstSchema: z.ZodType<Prisma.SocialFindFirstArgs> = z.object({ select: SocialFindFirstSelectSchema.optional(), include: z.lazy(() => SocialIncludeObjectSchema.optional()), orderBy: z.union([SocialOrderByWithRelationInputObjectSchema, SocialOrderByWithRelationInputObjectSchema.array()]).optional(), where: SocialWhereInputObjectSchema.optional(), cursor: SocialWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SocialScalarFieldEnumSchema, SocialScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SocialFindFirstArgs>;

export const SocialFindFirstZodSchema = z.object({ select: SocialFindFirstSelectSchema.optional(), include: z.lazy(() => SocialIncludeObjectSchema.optional()), orderBy: z.union([SocialOrderByWithRelationInputObjectSchema, SocialOrderByWithRelationInputObjectSchema.array()]).optional(), where: SocialWhereInputObjectSchema.optional(), cursor: SocialWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SocialScalarFieldEnumSchema, SocialScalarFieldEnumSchema.array()]).optional() }).strict();